...
然后，下载<img src="https://developer.nvidia.com/cuda-downloads" alt="NVIDIA驱动和CUDA">
并按照提示设置适当的路径。
...
!<img src="img/copyto.svg" alt="复制数据以在同一设备上执行操作">
:label:`fig_copyto`
...
<img src="https://discuss.d2l.ai/t/1841" alt="Discussions">
