...
```
    ...
    loss 0.232, train acc 0.917, test acc 0.901
    981.2 examples/sec on [device(type='cuda', index=0), device(type='cuda', index=1)]
...
```
    ...
    loss 0.382, train acc 0.829, test acc 0.835
    1514.6 examples/sec on [device(type='cuda', index=0), device(type='cuda', index=1)]
