...
!<img src="img/nlp-map-sa-cnn.svg" alt="将GloVe放入卷积神经网络架构进行情感分析">
...
!<img src="img/conv1d.svg" alt="一维互相关运算。阴影部分是第一个输出元素以及用于输出计算的输入和核张量元素：$0\times1+1\times2=2$">
:label:`fig_conv1d`
...
!<img src="img/conv1d-channel.svg" alt="具有3个输入通道的一维互相关运算。阴影部分是第一个输出元素以及用于输出计算的输入和核张量元素：$2\times(-1)+3\times(-3)+1\times3+2\times4+0\times1+1\times2=2$">
...
!<img src="img/conv1d-2d.svg" alt="具有单个输入通道的二维互相关操作。阴影部分是第一个输出元素以及用于输出计算的输入和内核张量元素： $2\times(-1)+3\times(-3)+1\times3+2\times4+0\times1+1\times2=2$">
:label:`fig_conv1d_2d`
...
!<img src="img/textcnn.svg" alt="textCNN的模型架构">
...
```
    ...
    loss 0.062, train acc 0.980, test acc 0.870
    3325.6 examples/sec on [device(type='cuda', index=0), device(type='cuda', index=1)]



    
!<img src="chapter_natural-language-processing-applications/sentiment-analysis-cnn_files/sentiment-analysis-cnn_15_1.svg" alt="svg">
...
<img src="https://discuss.d2l.ai/t/5720" alt="Discussions">
