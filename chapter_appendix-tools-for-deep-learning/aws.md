...
所有这些服务器都有多种类型，显示了使用的GPU数量。例如，p2.xlarge有1个GPU，而p2.16xlarge有16个GPU和更多内存。有关更多详细信息，请参阅<img src="https://aws.amazon.com/ec2/instance-types/" alt="Amazon EC2 文档">。
...
我们在这里下载CUDA 10.1。访问NVIDIA的<img src="https://developer.nvidia.com/cuda-toolkit-archive" alt="官方存储库"> 以找到下载链接，如 :numref:`fig_cuda`中所示。
...
1. 云提供了便利，但价格并不便宜。了解如何启动<img src="https://aws.amazon.com/ec2/spot/" alt="spot实例">以降低成本。
1. 尝试使用不同的GPU服务器。它们有多快？
1. 尝试使用多GPU服务器。你能把事情扩大到什么程度？

<img src="https://discuss.d2l.ai/t/5733" alt="Discussions">
