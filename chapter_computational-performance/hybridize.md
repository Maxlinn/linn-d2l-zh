...
!<img src="img/computegraph.svg" alt="命令式编程中的数据流">
...
```
    ...
    tensor([[-0.0426, -0.0429]], grad_fn=<AddmmBackward0>)
...
```
    ...
    无torchscript: 1.6992 sec
    有torchscript: 1.8071 sec
...
```
    ...
    -rw-rw-r-- 1 d2l-worker d2l-worker 651K Mar 15 01:05 my_mlp
...
<img src="https://discuss.d2l.ai/t/2788" alt="Discussions">
