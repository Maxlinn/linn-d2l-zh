...
在<img src="https://en.wikipedia.org/wiki/Glivenko%E2%80%93Cantelli_theorem" alt="同名定理（eponymous theorem）">中，
格里文科和坎特利推导出了训练误差收敛到泛化误差的速率。
在一系列开创性的论文中，
<img src="https://en.wikipedia.org/wiki/Vapnik%E2%80%93Chervonenkis_theory" alt="Vapnik和Chervonenkis">
将这一理论扩展到更一般种类的函数。
这项工作为统计学习理论奠定了基础。
...
<img src="https://discuss.d2l.ai/t/1806" alt="Discussions">
