...
```
    ...
    折1，训练log rmse0.169520, 验证log rmse0.155989
    折2，训练log rmse0.162300, 验证log rmse0.188638
    折3，训练log rmse0.163564, 验证log rmse0.168361
    折4，训练log rmse0.167817, 验证log rmse0.154740
    折5，训练log rmse0.163470, 验证log rmse0.183056
    5-折验证: 平均训练log rmse: 0.165334, 平均验证log rmse: 0.170157
