...
!<img src="img/eye-coffee.svg" alt="由于突出性的非自主性提示（红杯子），注意力不自主地指向了咖啡杯">
:width:`400px`
...
!<img src="img/eye-book.svg" alt="依赖于任务的意志提示（想读一本书），注意力被自主引导到书上">
:width:`400px`
:label:`fig_eye-book`
...
!<img src="img/qkv.svg" alt="注意力机制通过注意力汇聚将*查询*（自主性提示）和*键*（非自主性提示）结合在一起，实现对*值*（感官输入）的选择倾向">
:label:`fig_qkv`
...
!<img src="chapter_attention-mechanisms/attention-cues_files/attention-cues_5_0.svg" alt="svg">
...
<img src="https://discuss.d2l.ai/t/5764" alt="Discussions">
